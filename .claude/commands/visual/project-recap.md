...
model: opus
---
Read the visual-explainer skill at .claude/skills/visual-explainer/SKILL.md and follow its workflow, then generate a comprehensive visual project recap as a self-contained HTML page.
