...
**Examples:**
```
/visual/share ~/.agent/diagrams/my-diagram.html
/visual/share /tmp/visual-explainer-output.html
```
...
- **Vercel CLI or vercel-deploy skill** — If not installed: `npm i -g vercel`
